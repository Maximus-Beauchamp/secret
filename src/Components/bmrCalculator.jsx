...
function BMRCalculator() {
  ...
  const handleReturnToProfile = () => {
    setIsLoggedIn(true); // Assuming your authentication state management is done here
    navigate('/profile-info'); // Adjust the route as necessary
  };

  return (
    <div className='bmr-calculator'>
      <h2>STEP 2: Metrics and Primary Goal</h2>
      <form>
        {/* Gender */}
      ...
      <p>{result}</p>
      <button type='button' onClick={handleReturnToProfile}>Complete Profile Setup</button>
    </div>
  );
}
